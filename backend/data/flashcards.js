    ...
    flashcards: [
      ...
      },
      {
        ...
        options: {
          ...
          C:
            "Collaborate with them immediately to clarify the acceptance criteria.",
      ...
      },
      {
        ...
        options: {
          ...
          C:
            "To be a dynamic list of everything that might be needed in the product.",
      ...
      },
      {
        ...
        options: {
          A:
            "Tell the developers exactly how to write the code (e.g., which variable names to use).",
          B:
            "Define the specific conditions that must be met for a user story to be considered complete.",
    ...
    flashcards: [
      {
        ...
        options: {
          ...
          B:
            "Suggest they continue the discussion after the meeting so the rest of the team can get back to work.",
          C:
            "Tell them to stop talking and move on to the next person without solving the issue.",
      ...
      },
      {
        ...
        options: {
          ...
          C:
            "To cause the removal of impediments that the team cannot resolve themselves.",
      ...
      },
      {
        ...
        options: {
          ...
          B: "The Product Owner.",
          C:
            "The Scrum Team manages itself, but hiring/firing is typically an external management function, not a Scrum Master responsibility.",
      ...
      },
      {
        ...
        options: {
          A:
            "Tell the developer to stop their current work and do the urgent task.",
          B:
            "Intervene and explain that new requests must go through the Product Owner to protect the team's focus.",
    ...
    flashcards: [
      {
        ...
        options: {
          ...
          B:
            "It ensures users with visual impairments can read the text easily.",
      ...
      },
      {
        ...
        options: {
          ...
          B:
            "The design automatically adjusts its layout to look good on phone, tablet, and desktop screens.",
      ...
      },
      {
        ...
        options: {
          A:
            "To figure out the layout and structure without getting distracted by colors and details.",
      ...
      },
      {
        ...
        options: {
          A:
            "Make the button bigger and use a more distinct color to improve visual hierarchy.",
      ...
      },
      {
        ...
        options: {
          ...
          B:
            "To describe the image for users using screen readers (blind or low-vision users).",
    ...
    flashcards: [
      ...
      },
      {
        ...
        options: {
          ...
          B:
            '== checks for equality but allows type conversion (e.g., "5" equals 5), while === checks for strict equality (type must match).',
    ...
    flashcards: [
      ...
      },
      {
        ...
        options: {
          ...
          C:
            "To isolate the dependencies (libraries) for a specific project so they don't conflict with other projects.",
