      ...
      <div className="max-w-12xl mx-auto px-4">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center h-auto md:h-16 py-2 md:py-0">
          <div className="flex flex-col px-2 items-center md:items-start text-center md:text-left">
            <div className="text-lg sm:text-xl md:text-2xl font-bold text-black break-words max-w-xs sm:max-w-md md:max-w-full">
          ...
          <div className="flex space-x-6 mt-2 md:mt-0 justify-center md:justify-start">
            <NavLink to="/" className={linkStyle}>
              <FaHome className="inline mr-1 md:mr-2 -mt-1" />
              Home
            </NavLink>
            <NavLink to="/roles" className={linkStyle}>
              <FaUser className="inline mr-1 md:mr-2 -mt-1" />
              Roles
            </NavLink>
          </div>
        </div>
